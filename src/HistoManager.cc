...
void HistoManager::Book()
{
  ...
  const G4String title[] = 
                { "dummy",                                        //0
                  ...
                  "secondary gamma energy spectrum",         //14
                  "secondary neutron energy spectrum",      //15
                  "secondary electron energy spectrum",       //16
                  "secondary alpha energy spectrum",      //17  
                  "secondary nucleus energy spectrum"       //18 
                 };  
