...
//RegisterPhysics(new G4EmDNAPhysics());
 ...
 //Neutron physics
 // RegisterPhysics(new NeutronHPelastic());    
...
// SetCutsWithDefault();
  ...
  //G4Region* region;
  G4double lowlimit=500*eV;    ///MAY NEED TO CHANGE!!!
  G4ProductionCutsTable::GetProductionCutsTable()->SetEnergyRange(lowlimit,1*GeV);
G4ProductionCuts* cuts = new G4ProductionCuts;
 cuts->SetProductionCut(0.001*nm);  
}
